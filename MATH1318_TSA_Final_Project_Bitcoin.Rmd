...
In the ACF plot of Standardised Residuals (figure 13D) we only have late significant ACF lags with the Ljung Box test (titled p-values for Ljung Box statistic) having statistically significant lags.
...
**<UP TO HERE - THE REST IS MEG'S WRITING BASED ON PREVIOUS USE OF WRONG OBJECT. WE NEED TO MAKE SURE IT READS CORRECTLY >**
